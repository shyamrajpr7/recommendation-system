              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Your e-ticket is ready. Keep the booking reference for entry.',
                        style: TextStyle(
                          color: AppColors.success,
                          fontSize: 13,
                        ),
...
class _ETicketWidget extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${booking.movieGenre} \u2022 ${booking.theaterName} (${booking.city})',
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      booking.bookingRef,
                      style: TextStyle(color: AppColors.muted2, fontSize: 8),
                    ),
                  ],
                ),
              ],
  ...
  Widget _row(String l1, String v1, String l2, String v2) {
    return Row(
      children: [_info(l1, v1), const SizedBox(width: 20), _info(l2, v2)],
    );
  }
